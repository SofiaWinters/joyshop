...
pub struct Config {
    ...
    pub minus: KeyAction,
    pub stick: KeyAction,
    pub stick_top_left: KeyAction,
    pub stick_top_center: KeyAction,
    pub stick_top_right: KeyAction,
    pub stick_bottom_left: KeyAction,
    pub stick_bottom_center: KeyAction,
    pub stick_bottom_right: KeyAction,
    pub up: KeyAction,
    pub down: KeyAction,
    pub left: KeyAction,
    pub right: KeyAction,
...
pub fn load_config_or_default() -> Arc<RwLock<Box<Config>>> {
    let default = Config {
        ...
        stick: KeyAction::None,
        stick_top_left: KeyAction::KeyClick(KeyCombination {
            name: "Finger".into(),
            key: Key::N,
            ctrl: false,
            alt: false,
        ...
        stick_top_center: KeyAction::KeyClick(KeyCombination {
            name: "Brush".into(),
            key: Key::B,
            ctrl: false,
            alt: false,
        ...
        stick_top_right: KeyAction::KeyClick(KeyCombination {
            name: "Dodge".into(),
            key: Key::O,
            ctrl: false,
            alt: false,
        ...
        stick_bottom_left: KeyAction::KeyHold(KeyCombination {
            name: "Rotate".into(),
            key: Key::R,
            ctrl: false,
            alt: false,
        ...
        stick_bottom_center: KeyAction::KeyHold(KeyCombination {
            name: "Grab".into(),
            key: Key::Space,
            ctrl: false,
            alt: false,
